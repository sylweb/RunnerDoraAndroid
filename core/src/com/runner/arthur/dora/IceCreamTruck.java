...
public class IceCreamTruck extends Ennemy {
    ...
    public IceCreamTruck(float x, float y) {
        super(x, y, SPRITE_WIDTH, SPRITE_HEIGHT, LIFE, DELTA_X_MOVE, DELTA_Y_MOVE, RessourceContainer.icTruckAnimLeft, RessourceContainer.icTruckAnimRight, RessourceContainer.icTruckDeadSprite, RessourceContainer.icTruckDeadSprite, VELOCITY_X);
